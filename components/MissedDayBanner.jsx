...
export function MissedDayBanner({ habits, onLogYesterday, onDismiss }) {
  ...
  return (
    <div className="mx-4 mb-3 bg-amber-500/8 border border-amber-500/20 rounded-2xl p-4">
      <div className="flex items-start justify-between gap-3">
        <div className="flex-1">
          <p className="text-sm font-medium text-amber-300 mb-0.5">Missed yesterday?</p>
        ...
        <button
          onClick={onDismiss}
          className="flex-shrink-0 p-1 text-neutral-600 active:text-neutral-400"
          aria-label="Dismiss"
        >
          <X size={16} />
        </button>
      ...
      <button
        ...
        className="mt-3 flex items-center gap-2 text-xs font-medium text-amber-400 py-1"
      >
        <RotateCcw size={13} />
