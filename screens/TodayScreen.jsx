        ...
        {weekDays.map(day => {
          ...
          return (
            <button
              ...
              className={`flex-1 flex flex-col items-center gap-1.5 ${isPast ? 'active:opacity-70' : ''}`}
              aria-label={isPast ? `Log ${day.date}` : undefined}
            >
              ...
              <div className={`w-7 h-7 rounded-full flex items-center justify-center text-xs font-mono transition-all ${
                day.isToday
                  ? 'border border-neutral-400 dark:border-neutral-500 text-neutral-700 dark:text-neutral-300'
                  : anyDone
                  ? 'bg-green-500/20 text-green-600 dark:text-green-400'
                  : isPast
                  ? 'text-neutral-400 dark:text-neutral-700 border border-dashed border-neutral-300 dark:border-neutral-800'
